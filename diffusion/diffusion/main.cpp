...
//                    dat->write(log10(dt));
//                    dat->add_column();
//                    dat->write(log10(solver->max_relative_error(E,s)));
//                    dat->add_column();
//                    dat->write(log10(solver->max_relative_error(I,s)));
//                    dat->add_column();
//                    dat->write(log10(solver->max_relative_error(C,s)));
//                    dat->add_column();
                    counter++;
                }


                if(fabs(time-200e-3)<=1e-8){
                    ...
                    //                    dat->printscreen(solver->max_relative_error(C,s),"som");
...
//                    dat->write(log10(solver->max_relative_error(C,s)));
//                    dat->new_row();
//                    dat->printscreen(log10(solver->max_relative_error(I,s)),"ec ");
//                    dat->printscreen(log10(solver->max_relative_error(C,s)),"ec ");
                    counter++;
                    break;
                }
